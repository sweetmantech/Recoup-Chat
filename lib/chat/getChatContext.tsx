...
const getChatContext = async () => {
  ...
  let scoreContext = `\n3. Scores of fan ( please calculate a count for each username to indicate the number of times each player get the score. You should get playing count based on username as unique value.): \n`;
