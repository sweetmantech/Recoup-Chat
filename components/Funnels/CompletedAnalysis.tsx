...
const CompletedAnalysis = () => {
  ...
  return (
    <>
      ...
      <p>{`${selectedArtist?.name} has ${result?.followerCount} followers. We've analyzed your most recent 100 engagements in this quick scan. Select a fan segmentation below to generate a detailed report for brand partnership opportunities.`}</p>
