          ...
          {thought === STEP_OF_ANALYSIS.FINISHED ? (
            result?.videos?.length ? (
              <>
                ...
                {`We categorized ${result?.name}'s fan into ${Object.keys(segments).length} different segments - click any to explore. The agent is running in the background and will notify you of new insights!`}
