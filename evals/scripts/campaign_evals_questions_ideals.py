...
evals_questions_ideals = [
    ...
    },
    {
        ...
        "criteria": "The answer is the list of playlist names like reference answer. Playlist names can also consist only of emoji unicode. So, please, don't ignore this case."
    },
    {
